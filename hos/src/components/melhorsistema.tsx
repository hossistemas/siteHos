      ...
      return(
        <div className='bg-fundo '>
            ...
            <div className='text-[1.25rem] pt-[1rem] text-left font-extrabold text-grafite leading-tight w-[16rem] flex mx-auto pb-[2rem] tablet:pb-[4rem] tablet:text-center tablet:w-[42.4rem] tablet:text-[2rem]'>
                ...
                <SwiperSlide>
                    <div className='w-[16rem] h-[15rem] mb-[5rem]  mx-[0.8rem] justify-center bg-white  drop-shadow-lg rounded-xl tablet:w-[21.1rem] tablet:h-[25.4rem]'>
                        <Image src={inteligente} alt='' className='flex mx-auto pt-[2rem] w-[3rem] pb-3 tablet:w-[5.3rem] tablet:pt-[2.8rem] tablet:pb-[2rem]'/>
                ...
                <SwiperSlide>
                    <div className='w-[16rem] h-[15rem] mb-[5rem]  mx-[0.8rem] justify-center bg-white  drop-shadow-lg rounded-xl tablet:w-[21.1rem] tablet:h-[25.4rem]'>
                        <Image src={PBM} alt='' className='flex mx-auto pt-[2rem] w-[3rem] pb-3 tablet:w-[4.9rem] tablet:pt-[4rem] tablet:pb-[2rem]'/>
                ...
                <SwiperSlide>
                    <div className='w-[16rem] h-[15rem] mb-[5rem]  mx-[0.8rem] justify-center bg-white  drop-shadow-lg rounded-xl tablet:w-[21.1rem] tablet:h-[25.4rem]'>
                        <Image src={fidelizacao} alt='' className='flex mx-auto pt-[2rem] w-[3rem] pb-3 tablet:w-[6.3rem] tablet:pt-[4rem] tablet:pb-[2rem]'/>
                ...
                <SwiperSlide>
                    <div className='w-[16rem] h-[15rem] mb-[5rem]  mx-[0.8rem] justify-center bg-white  drop-shadow-lg rounded-xl tablet:w-[21.1rem] tablet:h-[25.4rem]'>
                        <Image src={suporte} alt='' className='flex mx-auto pt-[2rem] w-[3rem] pb-3 tablet:w-[6rem] tablet:pt-[3.5rem] tablet:pb-[2rem]'/>
