...
export function Cta(props: CtaProps){
    ...
    return(
        <div >
            ...
            <div className="w-[20rem] h-[13.9rem] bg-white rounded-lg absolute left-5 bottom-[-219rem] tablet:w-[57.5rem] tablet:h-[24rem] tablet:drop-shadow-lg tablet:bottom-[-215rem] tablet:left-[10rem] ">
                <div>
