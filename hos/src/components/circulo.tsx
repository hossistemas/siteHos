...
export function Circulo(props: CirculoProps){
    ...
    return(
        <div className="bg-fundo -mt-[5.5rem] ">
            <div className="pt-[6rem] tablet:grid tablet:grid-cols-2 tablet:mx-auto tablet:max-w-[1000px] tablet:pt-[4rem] tablet:pb-[3rem] tablet:justify-center tablet:items-center">
