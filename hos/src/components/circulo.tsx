    ...
    return(
        <div className="bg-fundo -mt-[5.5rem] ">
            <div className="pt-[6rem] tablet:grid tablet:grid-cols-2 tablet:mx-auto tablet:max-w-[1000px] tablet:pt-[4rem] tablet:justify-center tablet:items-center">
               <div className="mx-auto tablet:col-span-2 tablet:mx-auto tablet:pt-[1rem] tablet:pb-[3rem]">
                ...
                <Image src={circulo} alt='' className="mx-auto max-w-[20rem] h-auto flex justify-center items-center self-center tablet:col-start-2 tablet:max-w-[33rem]  tablet:h-auto "/>
                
                <div className="mx-auto pb-[4rem] tablet:col-start-1 tablet:-mt-[24rem] tablet:-ml-[7rem]">
