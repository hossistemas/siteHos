...
export function Circulo(props: CirculoProps){
    ...
    return(
        <div className="bg-fundo -mt-[5.5rem] ">
            <div className="pt-[6rem] tablet:grid tablet:grid-cols-2 tablet:mx-auto tablet:w-[1400px]  tablet:pb-[3rem] tablet:justify-center tablet:items-center">
               <div className="mx-auto tablet:col-span-2 tablet:mx-auto tablet:pt-[1rem] tablet:pb-[1rem]">
                ...
                <Image src={circulo} alt='' className="mx-auto w-[20rem] h-auto flex justify-center items-center self-center tablet:col-start-2 tablet:w-[33rem]  tablet:h-auto tablet:mr-[15rem]"/>
                
                <div className="mx-auto pb-[4rem] tablet:col-start-1 tablet:-mt-[33rem] tablet:ml-[3rem]">
