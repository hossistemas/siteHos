            ...
            <div className="py-[3.75rem] tablet:grid grid-cols-3 tablet:mx-auto tablet:max-w-[59.8rem] tablet:py-[6rem]">
                ...
                <div className="">
                    <div className="bg-white w-[5.7rem] h-[5.6rem] mt-[1.5rem]  rounded-3xl drop-shadow-2xl flex justify-center mx-auto tablet:w-[8.1rem] tablet:h-[8rem]">
                        <Image src={gestao} alt="" className=" w-[3.9rem] h-auto tablet:w-[5rem] tablet:h-auto"/>
                    </div>
                ...
                <div className="">
                    ...
                    <p className="w-[12.25rem] text-[0.87rem] text-center mt-[0.6rem] mx-auto text-grafite tablet:w-[15.75rem] tablet:text-[1rem]">Integração com instituições financeiras para facilitar a emissão de remessas e retorno.</p>
                </div>
