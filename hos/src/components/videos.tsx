            ...
            <div className='tablet:grid tablet:grid-cols-2 tablet:gap-y-10 tablet:pb-[6rem]'>
                <div className='mx-auto'>
                    <Link href='https://www.youtube.com/watch?v=_l5KEDfDiDc&ab_channel=HosSistemas' target='_blank'>
                        <Image src={indicadores} alt='' className='mx-auto tablet:w-[31rem] hover:w-[32rem] transition-all ease-in-out duration-300' />
                    </Link>
                ...
                <div className='mx-auto py-[2rem] tablet:py-0'>
                    <Link href='https://www.youtube.com/watch?v=lm1aYxNGV3E&ab_channel=HosSistemas' target='_blank'>
                        <Image src={dicas} alt='' className='mx-auto tablet:w-[31rem] hover:w-[32rem] transition-all ease-in-out duration-300' />
                    </Link>
                ...
                <div className='mx-auto'>
                    <Link href='https://www.youtube.com/watch?v=gyJnJdlnHQI&ab_channel=HosSistemas' target='_blank'>
                        <Image src={prosperar} alt='' className='mx-auto tablet:w-[31rem] hover:w-[32rem] transition-all ease-in-out duration-300' />
                    </Link>
                ...
                <Link href='https://www.youtube.com/watch?v=RGg3OHoguWo&t=2s' target='_blank'>
                    <Image src={frente} alt='' className='mx-auto tablet:w-[35rem] hover:w-[36rem] transition-all ease-in-out duration-300' />
                </Link>
