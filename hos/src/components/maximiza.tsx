            ...
            <div className="pt-[6rem] tablet:mx-auto tablet:max-w-[1000px] tablet:pt-[4rem] tablet:justify-center tablet:items-center">
                ...
                <div className="pt-[3rem] tablet:mx-auto tablet:flex tablet:py-[6.5rem] tablet:gap-x-2">
                   ...
                   <div className="bg-white w-[17.25rem] h-[11.875rem] rounded-xl drop-shadow-lg mx-auto tablet:w-[23.3rem] tablet:h-[17.9rem] ">
                        ...
                        <h2 className="text-[1rem] pt-[4.4rem] text-grafite font-extrabold leading-tight text-center tablet:text-center tablet:text-[1.5rem]  tablet:max-w-[15rem] tablet:mx-auto"> Controle da Produção Magistral</h2>  
                    ...
                    <div className="bg-white w-[17.25rem] h-[11.875rem] rounded-xl drop-shadow-lg mx-auto  mt-[3rem] tablet:w-[23.3rem] tablet:h-[17.9rem] tablet:mt-0">
                        ...
                        <h2 className="text-[1rem] pt-[4.4rem] w-[8rem] mx-auto text-grafite font-extrabold leading-tight text-center tablet:text-center tablet:text-[1.5rem]  tablet:w-[13rem] tablet:mx-auto">Integração Filiais e Laboratórios </h2>  
                    ...
                    <div className="bg-white w-[17.25rem] h-[11.875rem] rounded-xl drop-shadow-lg mx-auto mt-[3rem] tablet:w-[23.3rem] tablet:h-[17.9rem] tablet:mt-0">
                        ...
                        <h2 className="text-[1rem] pt-[4.4rem] text-grafite font-extrabold leading-tight text-center tablet:text-center tablet:text-[1.5rem]  tablet:max-w-[31rem]">Pesagem Monitorada </h2>  
