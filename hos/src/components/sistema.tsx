...
export function Sistema(props: SistemaProps) {
  ...
  useEffect(() => {
    ...
    <div className="relative bg-fundo">
      ...
      <div className="carousel-pagination  flex justify-center -mt-[2rem] tablet:visible tablet:flex tablet:justify-center">
        ...
        <div className="flex justify-center mt-[0.5rem] tablet:visible tablet:flex tablet:justify-center tablet:mt-[1rem]">
            <button
