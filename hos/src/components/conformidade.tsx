    ...
    return(
        ...
        <div className="-mt-[5rem] py-[4rem] tablet:grid tablet:grid-cols-2 tablet:pt-[4rem] tablet:w-[1200px] tablet:mx-auto">
           <div className="mx-auto tablet:mt-[5rem] ">
                ...
                <h2 className="text-[1.25rem] pb-[1.5rem] text-grafite font-extrabold leading-tight text-center w-[18rem] mx-auto tablet:text-left tablet:text-[2rem] tablet:w-[25.12rem] ">Fique em conformidade com as obrigações fiscais</h2>                 
                <p className="text-[0.87rem] text-grafite mx-auto my-[1.38rem] w-[18rem] text-center tablet:text-left tablet:text-[1.25rem] tablet:w-[21.87rem] tablet:mx-0">
