            ...
            <div className=" mx-auto max-w-[460px] tablet:flex tablet:justify-center tablet:items-center  tablet:max-w-[1200px] tablet:h-[570px]">
                ...
                <div className='pt-[3rem] px-[3rem] max-w-[500px] tablet:pl-[2rem] tablet: tablet:max-w-[590px]  '>
                    ...
                    <Link href="/sobre/contato">
                        <button className={`w-[16rem] text-[1rem] font-regular mb-[1.3rem] px-[1.3rem] py-[0.4rem] rounded-md tablet:text-[1.2rem] tablet:w-[20rem] tablet:h-[3rem] tablet:transition-all tablet:ease-in-out tablet:duration-500 hover:font-bold ${buttonClassName}`}>{buttonName}</button>
                    </Link>
                </div>
