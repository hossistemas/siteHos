    ...
    return(
        ...
        <div className='bg-fundo pb-[5rem] tablet:pb-[1rem] '>
                ...
                <div className='mx-auto flex justify-center items-center'>
                    <h4 className='-mt-[11rem] ml-[3rem] mb-5 w-[15rem] text-white text-[1.5rem] font-bold leading-tight tablet:text-[2.25rem] tablet:w-[37rem] tablet:ml-[-15rem] tablet:-mt-[29rem] tablet:pb-[4rem]'>Conteúdos descomplicados para você aprender mais sobre a gestão do seu negócio</h4>
