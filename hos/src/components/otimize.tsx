...
export function Otimize(props: OtimizeProps){
    ...
    return(
        <div className="bg-fundo -mt-[5.5rem] overflow-x-hidden overflow-y-hidden">
            <div className="pt-[6rem] tablet:grid tablet:grid-cols-2 tablet:mx-auto tablet:w-[1400px] tablet:pt-[4rem] tablet:justify-center tablet:items-center">
