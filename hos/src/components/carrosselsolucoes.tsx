...
export function Render(props: RenderProps) {
  ...
  useEffect(() => {
    ...
    <div className="relative bg-fundo">
        <div className='text-[1.25rem] w-[15rem] text-center pt-[5rem] font-extrabold text-grafite leading-tight  flex mx-auto pb-[2rem] tablet:text-center tablet:w-[42.4rem] tablet:text-[2rem] tablet:pb-[4rem]'>
      ...
      <div className="grid grid-cols-1 h-[55rem] tablet:flex  tablet:w-[1090px] tablet:mx-auto tablet:justify-center tablet:h-auto tablet:pb-[3rem]">
        <div className=" tablet:flex tablet:justify-center ">
            ...
            <div  className=' w-[16rem] h-[15rem] mx-auto justify-center bg-white  drop-shadow-lg rounded-xl tablet:w-[23.3rem] tablet:h-[23rem] tablet:mx-6'>
