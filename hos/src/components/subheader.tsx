    ...
    return(
        <>
         <div className='bg-vermelho w-auto h-[8.7rem] tablet:h-[5.75rem]'>
            <ul className='grid grid-cols-2 text-[0.87rem] font-semibold text-fundo tablet:flex tablet:justify-center tablet:gap-x-5 tablet:text-[1rem]  tablet:w-[1200px] tablet:px-[8rem]' >

                <Link href={hrefPrimeiro}>
                    <li className='flex w-[7rem]  text-center mx-auto justify-center self-center py-[1.57rem] tablet:py-[2.13rem] tablet:px-[4rem]'>{primeiro}</li>
                </Link>
