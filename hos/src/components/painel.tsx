...
export function Painel(props: PainelProps){
    ...
    return(
        ...
        <div className=" tablet:mx-auto tablet:grid tablet:grid-cols-2 tablet:pt-[4rem] tablet:w-[1200px]">
           <div className="mx-auto tablet:col-start-2 tablet:-mb-[15rem]">
                ...
                <button className="hidden tablet:flex tablet:items-center tablet:justify-center tablet:visible tablet:w-[11rem] tablet:h-[3.5rem] tablet:bg-gradient-to-b from-magenta to-laranja tablet:rounded-lg tablet:hover:bg-gradient-to-b tablet:hover:from-darker tablet:hover:to-darker tablet:hover:duration-500">
