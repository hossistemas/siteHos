...
export function Heroquemsomos(props : HeroquemsomosProps){
    ...
    return(
        ...
        <div className='bg-fundo pb-[5rem] tablet:pb-[1rem] '>
                ...
                <div className=''>
                    <h1 className='-mt-[7rem] ml-[3rem] mb-5 w-[17rem] text-white text-[1.5rem] font-bold leading-none tablet:text-[2.25rem]'>Somos soluções para automação de farmácias e drogarias</h1>
