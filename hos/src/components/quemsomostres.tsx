...
export function Tres(props: TresProps){
    ...
    return(
        <div className="bg-fundo -mt-[5.5rem] pb-[5rem]">
            <div className="pt-[3rem] tablet:mx-auto tablet:max-w-[1200px] tablet:pt-[8rem] tablet:justify-center tablet:items-center">
                <div className="pt-[3rem] tablet:mx-auto tablet:flex tablet:py-[6.5rem] tablet:gap-x-6">

                       
                   <div className="bg-white w-[16.257rem] h-[17.8rem] rounded-4xl drop-shadow-lg mx-auto tablet:w-[24rem] tablet:h-[24rem]  group hover:bg-gradient-to-b to-magenta from-laranja transition-all ease-in duration-1000">
                        <div className="absolute bg-white w-[4.8rem] h-[4.7rem] rounded-3xl flex justify-center mx-auto drop-shadow-xl -mt-6 left-[6rem] tablet:drop-shadow-tres tablet:w-[7.2rem] tablet:h-[7.1rem] tablet:left-[8rem] tablet:-mt-[5.5rem] tablet:rounded-4xl">
...
as necessidades dos clientes, colaboradores, parceiros e sócios.</p>
                    ...
                    <div className="bg-white w-[16.257rem] h-[17.8rem] rounded-4xl drop-shadow-lg mx-auto mt-[3rem] tablet:w-[25rem] tablet:h-[24rem] tablet:mt-0 group hover:bg-gradient-to-b to-magenta from-laranja transition-all ease-in duration-1000">
                            <div className="absolute bg-white w-[4.8rem] h-[4.7rem] rounded-3xl flex justify-center mx-auto drop-shadow-xl -mt-6 left-[6rem] tablet:w-[7.2rem] tablet:h-[7.1rem] tablet:drop-shadow-tres tablet:left-[8.7rem] tablet:-mt-[5.5rem] tablet:rounded-4xl ">
