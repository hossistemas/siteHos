...
export default function Processos() {
  return(
      ...
      <HeroSection 
        ...
        img={manipulacao} buttonName={'Solicite uma demonstração'} imageClassName={'mb-2 tablet:ml-[8rem] tablet:h-auto tablet:w-[43rem]  tablet:mb-[-2.44rem] float-right' } linkName={"/sobre/contato"}      /> 
      <Maximize />
      <Gestao />
      <Emuitomais />
