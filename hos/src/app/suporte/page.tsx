...
export default function Suporte() {
  return(
      ...
      <HeroSection 
                          ...
                          textClassName={"text-grafite leading-tight w-[28.8rem]"}
                          buttonClassName={"bg-white border-2 border-vermelho text-vermelho hover:font-bold hover:bg-darker hover:border-white hover:text-white hover:transition hover:duration-500"}
